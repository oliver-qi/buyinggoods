...
public class TranslateChinese {
    public static void main(String[] args) throws Exception {
        (new TranslateChinese()).run();
    }

    //  填写网页上申请的appkey 如 $apiKey="g8eBUMSokVB1BHGmgxxxxxx"
    private final String appKey = "pl72W7ZWVGOGQVnwhWOr5H4f";

    // 填写网页上申请的APP SECRET 如 $secretKey="94dc99566550d87f8fa8ece112xxxxx"
    private final String secretKey = "BG6Z143VIByY0CajE1tz06jxM0ZjHvCq";
    ...
    private void run() throws Exception {
        ...
        if (contentType.contains("audio/")) {
            ...
            File file = new File("F://file//result." + format); // 打开mp3文件即可播放
